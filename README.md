...
```text
https://github.com/jxb412/YunQiao-Image-Studio/releases/tag/v0.1.10
```

客户端文件：

- Windows x64 便携版：`YunQiao-Image-Studio-0.1.10-win-x64-portable.exe`
...
Windows 版本下载后双击即可运行，不需要安装 Node.js、npm 或 Electron。macOS 版本当前未做 Apple Developer ID 签名和公证，首次打开方式见本文的 macOS 说明。
